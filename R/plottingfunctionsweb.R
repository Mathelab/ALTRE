...
plotBoxplot <- function() {
  categ <- c('A1', 'A2', 'B1', 'B2', 'B3', 'B4')

  X <- list(
    c(760, 801, 848, 895, 965, 965),
    c(733, 853, 939, 980, 1080, 965),
    c(714, 762, 817, 870, 918, 965),
    c(724, 802, 806, 871, 950, 965),
    c(834, 836, 864, 882, 910, 965)
  )
